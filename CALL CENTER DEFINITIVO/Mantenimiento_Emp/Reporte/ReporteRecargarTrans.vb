...
Public Class ReporteRecargarTrans
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "ReporteRecargarTrans.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReporteRecargarTrans
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReporteRecargarTrans = New ReporteRecargarTrans()
        rpt.Site = Me.Site
        Return rpt
    End Function
