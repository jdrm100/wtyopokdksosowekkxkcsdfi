...
Public Class ReporteAntDetallado
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "ReporteAntDetallado.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReporteAntDetallado
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReporteAntDetallado = New ReporteAntDetallado()
        rpt.Site = Me.Site
        Return rpt
    End Function
