...
Public Class ANTIGUEDAD_GESTOR_CONTABILIDAD
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "ANTIGUEDAD_GESTOR_CONTABILIDAD.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedANTIGUEDAD_GESTOR_CONTABILIDAD
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ANTIGUEDAD_GESTOR_CONTABILIDAD = New ANTIGUEDAD_GESTOR_CONTABILIDAD()
        rpt.Site = Me.Site
        Return rpt
    End Function
