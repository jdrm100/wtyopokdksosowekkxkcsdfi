...
Public Class ReporteReacargaTran
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "ReporteReacargaTran.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReporteReacargaTran
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReporteReacargaTran = New ReporteReacargaTran()
        rpt.Site = Me.Site
        Return rpt
    End Function
