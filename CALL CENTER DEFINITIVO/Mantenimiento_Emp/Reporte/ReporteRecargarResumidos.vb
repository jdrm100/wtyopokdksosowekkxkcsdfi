...
Public Class ReporteRecargarResumidos
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "ReporteRecargarResumidos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReporteRecargarResumidos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReporteRecargarResumidos = New ReporteRecargarResumidos()
        rpt.Site = Me.Site
        Return rpt
    End Function
